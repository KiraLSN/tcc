    ...
    ?>
      ...
      <form class="form_linha" method="post" name="editar_aluno" enctype="multipart/form-data">
            ...
            ?>
              <div class="forms_exta ds-none" style=" width: 100%; padding: 2%; background: #f1f1f1; border: 0.9% solid #333;">
                ...
                <div class="box box50">
                  ...
                  <input type="file" name="arq_ori1" required class="" style="display: block; width: 100%; border: 1px solid #b1b1b1; padding: 1%" />
                ...
                <div class="box box50 no-margim">
                  ...
                  <input type="file" name="arq_ori2" required class="" style="display: block; width: 100%; border: 1px solid #b1b1b1; padding: 1%" />
              ...
              <div class="box box50">
                ...
                <input type="file" name="arq_ori3" required class="" style="display: block; width: 100%; border: 1px solid #b1b1b1; padding: 1%" />
              ...
              <div class="box box50 no-margim">
                ...
                <!-- <label class="label_file" for='selecao-arquivo2'>Selecionar um arquivo</label> -->
                <input id='' type="file" name="arq_ori4" required class="" style=" display: block; width: 100%; border: 1px solid #b1b1b1; padding: 1%" />
                <div class="limpar"></div>
        ...
        <div class="box box50">
          ...
          <!-- <label class="label_file" for='selecao-arquivo2'>Selecionar um arquivo</label> -->
          <input id='' type="file" name="user_thumb9" required class="" style=" display: block; width: 100%; border: 1px solid #b1b1b1; padding: 1%" />
          <div class="limpar"></div>
            ...
            ?>
              ...
              <div class="box box100">
                ...
                <?php if ($resultado["arq_ori4"] == "") : ?>
                  <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                <?php else : ?>
                  <a href="<?= HOME; ?>imagens_site/<?= $resultado["arq_ori4"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                <?php endif; ?>
              </div>
        ...
        <div class="box box50">
          ...
          <div class="box box100">
            ...
            <?php if ($resultado["arq_ori5"] == "") : ?>
                  <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                <?php else : ?>
                  <a href="<?= HOME; ?>imagens_site/<?= $resultado["arq_ori5"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                <?php endif; ?>
          </div>
          ...
          <div class="box box100">
            <p class="texto_form">Parecer/protocolo do Comitê de Ética (CEP) <font color=red>*</font>
             ...
             <?php if ($resultado["arq_ori6"] == "") : ?>
                  <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                <?php else : ?>
                  <a href="<?= HOME; ?>imagens_site/<?= $resultado["arq_ori6"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                <?php endif; ?>
          </div>
          ...
          <div class="box box100">
            ...
            <?php if ($resultado["arq_ori7"] == "") : ?>
                  <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                <?php else : ?>
                  <a href="<?= HOME; ?>imagens_site/<?= $resultado["arq_ori7"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                <?php endif; ?>
          </div>
          ...
          <div class="box box100">
            ...
            <?php if ($resultado["arq_ori8"] == "") : ?>
                  <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                <?php else : ?>
                  <a href="<?= HOME; ?>imagens_site/<?= $resultado["arq_ori8"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                <?php endif; ?>
          </div>
          ...
          <div class="box box100">
            ...
            <?php if ($resultado["arq_ori9"] == "") : ?>
                  <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                <?php else : ?>
                  <a href="<?= HOME; ?>imagens_site/<?= $resultado["arq_ori9"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                <?php endif; ?>
          </div>
          ...
          <div class="box box100">
            ...
            <?php if ($resultado["arq_ori10"] == "") : ?>
                  <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                <?php else : ?>
                  <a href="<?= HOME; ?>imagens_site/<?= $resultado["arq_ori10"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                <?php endif; ?>
          </div>
          ...
          <div class="box box100">
            ...
            <?php if ($resultado["arq_ori11"] == "") : ?>
                  <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                <?php else : ?>
                  <a href="<?= HOME; ?>imagens_site/<?= $resultado["arq_ori11"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                <?php endif; ?>
          </div>
          ...
          <div class="box box100">
            ...
            <?php if ($resultado["arq_ori12"] == "") : ?>
                  <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                <?php else : ?>
                  <a href="<?= HOME; ?>imagens_site/<?= $resultado["arq_ori12"]; ?>" style=" color: black" target="_blank">Verificar arquiv</a>
                <?php endif; ?>
          </div>
          <div class="limpar"></div>
        </div>
        ...
        <div class="box box50 no-margim">
          ...
          <div class="box box100">
            ...
            <?php if ($resultado["arq_co3"] == "") : ?>
                  <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                <?php else : ?>
                  <a href="<?= HOME; ?>imagens_site/<?= $resultado["arq_co3"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                <?php endif; ?>
          </div>
          ...
          <div class="box box100">
            ...
            <?php if ($resultado["arq_co4"] == "") : ?>
                  <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                <?php else : ?>
                  <a href="<?= HOME; ?>imagens_site/<?= $resultado["arq_co4"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                <?php endif; ?>
          </div>
          ...
          <div class="box box100">
            ...
            <?php if ($resultado["arq_6"] == "") : ?>
                  <p class="texto_form" style=" color: red">Arquivo não enviad</p>
                <?php else : ?>
                  <a href="<?= HOME; ?>imagens_site/<?= $resultado["arq_6"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                <?php endif; ?>
          </div>
        ...
        <div class="box box100">
          ...
          <div class="box box100">
            ...
            <?php if ($resultado["arq_co"] == "") : ?>
                  <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                <?php else : ?>
                  <a href="<?= HOME; ?>imagens_site/<?= $resultado["arq_co"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                <?php endif; ?>
          </div>
          ...
          <div class="box box100">
            ...
            <?php if ($resultado["arq_co2"] == "") : ?>
                  <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                <?php else : ?>
                  <a href="<?= HOME; ?>imagens_site/<?= $resultado["arq_co2"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                <?php endif; ?>
          </div>
        </div>
        <br>
