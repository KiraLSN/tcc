    ...
    ?>
      ...
      <form class="form_linha" method="post" name="editar_orientador" enctype="multipart/form-data">
        ...
        <div class="box box100">
          ...
          <div class="limpar"></div>
          <div class="box box50">
            <p class="texto_form">Comprovante de patrimônio gen.e de conhecimento tradicional(SIGEN)</p>
            <?php
            if ($resultado['arq_3'] <> '') :
            ?>
          ...
          <div class="limpar"></div>
          <div class="box box50">
            <p class="texto_form">Currículos na plataforma Lattes do CNPq(Obrigatório)</p>
            <?php
            if ($resultado['arq_5'] <> '') :
            ?>
          ...
          <div class="box box100">
            ...
            ?>
              <div class="forms_exta ds-none" style=" width: 100%; padding: 2%; background: #f1f1f1; border: 0.9% solid #333;">
                ...
                <div class="box box50">
                  <p class="texto_form">Comprovante de patrimônio genético e de conhecimento tradicional(SIGEN)</p>
                  ...
                  <?php else : ?>
                    <a href="<?= HOME; ?>imagens_site/<?= $resultado["arq_ori1"]; ?>" style=" color: red" target="_blank">Verificar arquivo!</a>
                  <?php endif; ?>
                </div>
                <div class="box box50 no-margim">
                  ...
                  <?php if ($resultado["arq_ori2"] == "") : ?>
                    <p class="texto_form" style=" color: red">Arquivo não enviado!</p>
                  <?php else : ?>
                    <a href="<?= HOME; ?>imagens_site/<?= $resultado["arq_ori2"]; ?>" style=" color: red" target="_blank">Verificar arquivo!</a>
                  <?php endif; ?>
                </div>
              </div>
              <div class="box box50">
                ...
                <?php if ($resultado["arq_ori3"] == "") : ?>
                  <p class="texto_form" style=" color: red">Arquivo não enviado!</p>
                <?php else : ?>
                  <a href="<?= HOME; ?>imagens_site/<?= $resultado["arq_ori3"]; ?>" style=" color: red" target="_blank">Verificar arquivo!</a>
                <?php endif; ?>
              </div>
              <div class="box box50 no-margim">
                ...
                <?php if ($usuario_["arq_ori4"] == "") : ?>
                  <p class="texto_form" style=" color: red">Arquivo não enviado!</p>
                <?php else : ?>
                  <a href="<?= HOME; ?>imagens_site/<?= $usuario_["arq_ori4"]; ?>" style=" color: red" target="_blank">Verificar arquivo!</a>
                <?php endif; ?>
              </div>
    ...
    ?>
      ...
      <form class="form_linha" method="post" name="editar_aluno" enctype="multipart/form-data">
        ...
        <div class="box box50">
          ...
          <div class="box box100">
            <p class="texto_form">Currículos na plataforma Lattes do CNPQ <font color=red>*</font>
            </p>
