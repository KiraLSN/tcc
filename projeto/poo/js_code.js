$(window).load(function() {
  ...
  $(".cadastrar_total_contetudo2").css({ "max-height": novamodal });
  $(".cadastrar_total_contetudo3").css({ "max-height": novamodal });
...
$(function() {
  ...
  function triggerNotify(data) {
    var triggerContent =
      "<div class='trigger_notify trigger_notify_" +
      data.color +
      "' style='left: 100%; opacity: 0;'>";
    triggerContent +=
      "<p'><figure class='" +
      data.icon +
      "' style=' margin-right: 2%'></figure> " +
      data.title +
      "</p>";
    ...
    $(".trigger_notify")
      .stop()
      .animate({ left: "0", opacity: "1" }, 200, function() {
        $(this)
          .find(".trigger_notify_timer")
          .animate({ width: "100%" }, data.timer, "linear", function() {
            $(".trigger_notify").animate(
              { left: "100%", opacity: "0" },
              function() {
                $(this).remove();
              }
    ...
    $(".modal")
      ...
      .fadeIn(1000, function() {
        $(".msn-erro")
          .addClass("animated fadeInRight")
          .empty()
          .html("Erro inesperado, entre em contato com o administrador")
          .fadeIn(1000);
  ...
  $(".moldura_contetudo2").on("change", ".selecione_statauis", function() {
    ...
    if (valor == "1") {
      ...
      $(".alert_status")
        ...
        .fadeIn()
        .html(
          "Informar o pagamento ao seu cliente por e-mail, envie a nota fiscal abaixo e o número, para ser informado no e-mail que será enviado pelo e-mail."
        );
    } else if (valor == "3") {
      $(".alert_status")
        .empty()
        .fadeIn()
        .html(
          "Informar o número de rastreio para ser enviado por e-mail para o seu cliente."
        );
    } else if (valor == "4") {
      $(".alert_status")
        .empty()
        .fadeIn()
        .html(
          "Não será enviado e-mail para o seu cliente, porem as peças irão retonar para seu estoque."
        );
    }
  });

  $("body").on("change", ".seletipo", function() {
    var valor = $("option:selected").attr("value");
    if (valor == "1") {
      $(".forms_exta")
        .empty()
      ...
      $(".forms_exta")
        .html(
          '<h1 style="text-align: left; font-size: 1.4em; margin-bottom: 2%">Informações extras para renovação </h1><div class="box box100"><p class="texto_form">Avaliação do orientador(no caso de renovação), assinada (obrigatório)</p><input type="file" name="arq_ori4" class="" style=" display: block; width: 100%; border: 1px solid #b1b1b1; padding: 1%"/></div><div class="limpar">'
        )
        .fadeIn();
    }
  });
  ...
  $(".fecha_cadastro").click(function() {
    $(".cadastrar_total").fadeOut(function() {
      $(".modal_janela_c").fadeOut();
    });
    return false;
  });
  $(".fecha_cadastro2").click(function() {
    $(".cadastrar_total2").fadeOut(function() {
      $(".modal_janela_c").fadeOut();
    });
    return false;
  });
  $(".fecha_cadastro3").click(function() {
    $(".cadastrar_total3").fadeOut(function() {
      $(".modal_janela_c").fadeOut();
    });
    return false;
  });
  $(".cadastrar2").click(function() {
    ...
    $(".cadastrar_total2")
      ...
      .addClass("animated bounceInDown");
    setTimeout(function() {
      $(".cadastrar_total2").removeClass("animated bounceInDown");
    }, 1000);
    return false;
  });
  $(".cadastrar3").click(function() {
    ...
    $(".cadastrar_total3")
      ...
      .addClass("animated bounceInDown");
    setTimeout(function() {
      $(".cadastrar_total3").removeClass("animated bounceInDown");
    }, 1000);
    return false;
  });
  ...
  $("body").on("change", ".wc_loadimage", function() {
    ...
    if (this.files && this.files[0].type.match("image.*")) {
      ...
      $(".mensagem_imagem")
        .fadeIn()
        .html(
          "<p><b>ERRO AO SELECIONAR:</b> O arquivo <b>" +
            this.files[0].name +
            "</b> Não e válido! <b>Selecione uma imagem JPG ou PNG!</b></p>"
        );
      setTimeout(function() {
  ...
  $("body").on("change", "select[name=empresa]", function() {
    ...
    $.ajax({
      data: sender,
      beforeSend: function() {
        $("select[name=contato_empresa]").html(
          '<option value="0">Aguarde Carregando...</option>'
        );
      },
      success: function(resposta) {
        if (resposta == "") {
          complete: $("select[name=contato_empresa]").html(
            '<option value=" ">Esta categoria não tem subcategorias, selecione outra...</option>'
          );
        } else {
    ...
    $(".modal_janela_c").fadeIn(400, function() {
      $(".modal_exclusao")
        ...
        .html(
          "<h1>" +
            delaid_msn +
            '</h1><a href="" class="btn btn_red exca_sim ' +
            delaid_calor +
            '" id="' +
            delaid +
            '">Sim</a><a href="" class="btn btn_green exca_nao">Não</a>'
        );
      $(".modal_exclusao").fadeIn();
    });
    return false;
  ...
  $("body").on("focusout", ".cep_cad_parsa", function() {
    ...
    $(".load2")
      .empty()
      .html(
        '<img src="imagens_fixas/carregando.gif" width="20" height="20" />  Aguarde, enviando requisição!'
      )
      .fadeIn("fast");
    var delaid = $(this).val();
    ...
    $(this).ajaxSubmit({
      ...
      success: function(resposta) {
        ...
        if (resposta == 1) {
          ...
          $(".carregando2").fadeOut();
          triggerNotify({
            title: "Erro ao enviar, existem campos em branco!",
          ...
          $(".carregando2").fadeOut();
          alerta(
            "Livro já cadastrado, verifique o e-mail ou nome que já consta em nosso banco de dados!"
          );
        } else if (resposta == 7) {
          carregandoOut();
          $(".modal_janela_c").fadeIn();
    ...
    $.ajax({
      ...
      success: function(resposta) {
        if (resposta == 1) {
          ...
          triggerNotify({
            title:
              "Erro ao enviar, existem campos em branco, tente atualizar a página.",
            icon: "icon-notifications_active",
            color: "blue",
            timer: 4000
          });
    ...
    $(this).ajaxSubmit({
      ...
      success: function(resposta) {
        ...
        if (resposta == 1) {
          ...
          triggerNotify({
            title:
              "Usuário já cadastrado, verifique o e-mail ou nome que já consta em nosso banco de dados!",
            icon: "icon-notifications_active",
            color: "blue",
            timer: 4000
          });
    ...
    $.ajax({
      ...
      success: function(resposta) {
        ...
        if (resposta == 1) {
          ...
          $(".carregando_topo").fadeOut();
          triggerNotify({
            title: "Campo em branco, atualize sua página e tente novamente.",
            icon: "icon-notifications_active",
            color: "blue",
            timer: 4000
          });
    ...
    $(this).ajaxSubmit({
      ...
      success: function(resposta) {
        ...
        if (resposta == 1) {
          ...
          $(".carregando2").fadeOut();
          triggerNotify({
            title: "Desculpe o cupom não pode ter o código igual!",
            icon: "icon-notifications_active",
            color: "blue",
            timer: 4000
          });
    ...
    $.ajax({
      ...
      success: function(resposta) {
        ...
        if (resposta == 1) {
          carregandoOut();
          triggerNotify({
            title: "Bem vindo, Vou redireciona-lo para seu escritório online.",
            icon: "icon-thumbs-up2",
            color: "green",
            timer: 4000
          });
          ...
          triggerNotify({
            title: "Desculpe! Login ou senha não confere...",
            icon: "icon-thumbs-down2",
            color: "red",
            timer: 4000
          });
          ...
          triggerNotify({
            title:
              "Desculpe! Sua conta foi bloquiada entre em contato com o atendimento no e-mail: sac@casadossites.com",
            color: "blue",
            timer: 4000
          });
        } else if (resposta == 5) {
          ...
          triggerNotify({
            title:
              "Desculpe! Sua conta ainda não foi autenticada, procure o e-mail em sua caixa de entrada ou spam em sua conta de e-mail e click no link para valisar seu cadastro",
            color: "blue",
            timer: 4000
          });
        } else if (resposta == 6) {
    ...
    $.ajax({
      ...
      success: function(resposta) {
        if (resposta == 1) {
          ...
          triggerNotify({
            title:
              "Foi enviado para o seu e-mail as instruções para a alteração de senha.",
            icon: "icon-thumbs-up2",
            color: "green",
            timer: 4000
          });
          ...
          $(".senha_ button").html("Recuperar");
          triggerNotify({
            title: "Desculpe! E-mail não confere...",
            icon: "icon-thumbs-down2",
            color: "red",
            timer: 4000
          });
          ...
          $(".senha_ button").html("Recuperar");
          triggerNotify({
            title: "Erro ao enviar, campo de e-mail em branco!",
            icon: "icon-notifications_active",
            color: "blue",
            timer: 4000
          });
          ...
          triggerNotify({
            title:
              "Desculpe! Ocorreu um erro no sistema se persistir entre em contato com admin!",
            icon: "icon-notifications_active",
            color: "blue",
            timer: 4000
          });
    ...
    $(this).ajaxSubmit({
      ...
      success: function(resposta) {
        ...
        if (resposta == 1) {
          ...
          $(".carregando2").fadeOut();
          alerta(
            "Produto já cadastrado, verifique o código que já consta em nosso banco de dados!"
          );
        } else if (resposta == 6) {
          $(".carregando2").fadeOut();
  ...
  //===============================================================================================================================
  $(".moldura_contetudo").on(
    "submit",
    'form[name="email_cliente_form"]',
    function() {
    ...
    $(this).ajaxSubmit({
      ...
      success: function(resposta) {
        ...
        if (resposta == 1) {
          ...
          $(".carregando2").fadeOut();
          alerta(
            "Título repetido, por favor modifique o título e envie novamente!"
          );
        } else {
          triggerNotify({
            title: "Erro ao enviar, consultem um administrador",
    ...
    $.ajax({
      ...
      success: function(resposta) {
        ...
        if (resposta == 1) {
          ...
          triggerNotify({
            title: "Erro ao enviar, consultem um adminstrador",
            icon: "icon-thumbs-down2",
            color: "red",
            timer: 4000
          });
    ...
    interagir_form.ajaxSubmit({
      ...
      success: function(resposta) {
        ...
        if (resposta == 1) {
          ...
          triggerNotify({
            title: "Descrição não pode ser em branco",
            icon: "icon-notifications_active",
            color: "blue",
            timer: 4000
          });
          ...
          $(".moldura2").fadeIn();
          triggerNotify({
            title: "Vinculo igual já cadastrado!",
            icon: "icon-notifications_active",
            color: "blue",
            timer: 4000
          });
  ...
  var alterar_orientador = $('form[name="alterar_orientador"]');
  alterar_orientador.submit(function() {
    $(this).ajaxSubmit({
      url: urlphp,
      type: "post",
      data: { acao: "alterar_orientador" },
      beforeSubmit: function() {
        $(".cadastrar_total3").fadeOut();
        $(".carregando_sistem")
          .fadeIn()
          .addClass("animated zoomIn");
        setTimeout(function() {
      ...
      success: function(resposta) {
        ...
        if (resposta == 1) {
          ...
          carregandoOut2();
          $(".cadastrar_total3").fadeIn();
          triggerNotify({
            title: "O arquivo enviado não e um arquivo .PDF",
            icon: "icon-notifications_active",
            color: "blue",
            timer: 4000
          });
  ...
  var cad_alunos = $('form[name="cad_alunos"]');
  cad_alunos.submit(function() {
    $(this).ajaxSubmit({
      url: urlphp,
      type: "post",
      data: { acao: "cad_alunos" },
      beforeSubmit: function() {
        $(".cadastrar_total").fadeOut(function() {
          carregando();
        });
  ...
  $("body").on("click", ".ex_aluno", function() {
    //$('.ex_usuario').click(function () {
    var delaid = $(this).attr("id");
    var deladata = "acao=ex_aluno&del=" + delaid;
    $.ajax({
      data: deladata,
      beforeSend: function() {
        $(".carregando_topo").fadeIn();
  ...
  $("body").on("submit", 'form[name="cad_coorientador"]', function() {
    $(this).ajaxSubmit({
      url: urlphp,
      type: "post",
      data: { acao: "cad_coorientador" },
      beforeSubmit: function() {
        $(".cadastrar_total").fadeOut(function() {
          carregando();
        });
      ...
      success: function(resposta) {
        ...
        if (resposta == 1) {
          ...
          carregandoOut();
          triggerNotify({
            title: "Co-orientadores já cadastrado!",
            icon: "icon-notifications_active",
            color: "blue",
            timer: 4000
          });
  ...
  $("body").on("click", ".ex_coorientador", function() {
    //$('.ex_usuario').click(function () {
    var delaid = $(this).attr("id");
    var deladata = "acao=ex_coorientador&del=" + delaid;
    $.ajax({
      data: deladata,
      beforeSend: function() {
        $(".carregando_topo").fadeIn();
  ...
  $("body").on("click", ".cad_cordenador", function() {
    var delaid = $(this).attr("id");
    var deladata = "acao=cad_cordenador&id=" + delaid;
    $.ajax({
      data: deladata,
      beforeSend: function() {
        $(".moldura2").fadeOut(function() {
...
$("body").on("click", ".ver_cadastro", function() {
  var delaid = $(this).attr("id");
  var deladata = "acao=ver_cadastro&id=" + delaid;
  $.ajax({
    data: deladata,
    beforeSend: function() {
      $(".moldura2").fadeOut(function() {
  ...
  tinymce.init({
    ...
    toolbar1:
      "undo redo | bold italic underline | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | styleselect | link unlink anchor | image media | responsivefilemanager | forecolor backcolor | print preview code | source code",
    toolbar2: "",
    image_advtab: true,
    style_formats: [
    ...
    external_filemanager_path:
      "" + urlbase + "poo/app/Library/tinymce/js/filemanager/",
    filemanager_title: "Responsive Filemanager",
    external_plugins: {
      filemanager:
        "" + urlbase + "poo/app/Library/tinymce/js/filemanager/plugin.min.js"
    }
  });
  $("body").on("load", ".modal_janela_c", function() {
    tinymce.init({
      ...
      toolbar1:
        "undo redo | bold italic underline | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | forecolor | link unlink anchor |",
      toolbar2: "",
      image_advtab: true,
      style_formats: [
        { title: "Bold text", inline: "b" },
...
jQuery(function($) {
  ...
  $("#mascara_cpf2").mask("999.999.999-99");
