$(window).load(function () {
    ...
    $('.moldura_contetudo2').css({
        'max-height': novamodal
    });
    $('.moldura_contetudo').css({
        'max-height': novamodal
    });
    $('.alterar_total_contetudo').css({
        'max-height': novamodal
    });
    $('.cadastrar_total_contetudo').css({
        'max-height': novamodal
    });
...
$(function () {
        ...
        $.ajax({
            ...
            success: function (resposta) {
                if (resposta == 1) {
                    ...
                    triggerNotify({
                        title: "Erro ao enviar, existem campos em branco, tente atualizar a página.",
                        icon: "icon-notifications_active",
                        color: "blue",
                        timer: 4000
                    });
        ...
        $(this).ajaxSubmit({
            ...
            success: function (resposta) {
                ...
                if (resposta == 1) {
                    ...
                    $('.carregando2').fadeOut();
                    triggerNotify({
                        title: "Usuário já cadastrado, verifique o e-mail ou nome que já consta em nosso banco de dados!",
                        icon: "icon-notifications_active",
                        color: "blue",
                        timer: 4000
                    });
        ...
        $.ajax({
            ...
            success: function (resposta) {
                ...
                if (resposta == 1) {
                    ...
                    $('.login_ button').html('Entrar');
                    triggerNotify({
                        title: "Desculpe! Sua conta foi bloquiada entre em contato com o atendimento no e-mail: sac@casadossites.com",
                        color: "blue",
                        timer: 4000
                    });
                } else if (resposta == 5) {
                    ...
                    $('.login_ button').html('Entrar');
                    triggerNotify({
                        title: "Desculpe! Sua conta ainda não foi autenticada, procure o e-mail em sua caixa de entrada ou spam em sua conta de e-mail e click no link para valisar seu cadastro",
                        color: "blue",
                        timer: 4000
                    });
                } else if (resposta == 6) {
        ...
        $.ajax({
            ...
            success: function (resposta) {
                if (resposta == 1) {
                    carregandoOut();
                    triggerNotify({
                        title: "Foi enviado para o seu e-mail as instruções para a alteração de senha.",
                        icon: "icon-thumbs-up2",
                        color: "green",
                        timer: 4000
                    });
                    ...
                    $('.senha_ button').html('Recuperar');
                    triggerNotify({
                        title: "Desculpe! Ocorreu um erro no sistema se persistir entre em contato com admin!",
                        icon: "icon-notifications_active",
                        color: "blue",
                        timer: 4000
                    });
    ...
    $('.moldura_contetudo').on('submit', 'form[name="email_cliente_form"]', function () {
        ...
        email_cliente_form.ajaxSubmit({
            ...
            success: function (resposta) {
                // alert(resposta);
                if (resposta == 1) {} else if (resposta == 2) {
        ...
        $(this).ajaxSubmit({
            ...
            success: function (resposta) {
                ...
                if (resposta == 1) {
                    ...
                    carregandoOut();
                    triggerNotify({
                        title: "Título repetido, por favor modifique o título e envie novamente!",
                        icon: "icon-notifications_active",
                        color: "blue",
                        timer: 4000
                    });
        ...
        $(this).ajaxSubmit({
            ...
            success: function (resposta) {
                ...
                if (resposta == 1) {
                    ...
                    $('.carregando2').fadeOut();
                    triggerNotify({
                        title: "Erro ao enviar, consulte o Luciano",
                        icon: "icon-thumbs-down2",
                        color: "red",
                        timer: 4000
                    });
