        ...
        <form method="post" name="busca_usuario" class="form" style=" margin-top: 2%; padding: 0 1.8%">
            <div class="" style="width: 18%; float: right;">
                <a href="" class="btn btn_green fl-right cadastrar" style=" width: 90%; margin-top: 10%">
                    <figure class="icon-plus6" style="font-size: 1.1em; margin-top: -0.9%; margin-right: 2%;"></figure> <?= $titulo_botao_de_acesso; ?>
                </a>
        ...
        <form class="form_linha" method="post" name="cad_usuario">
            <div style="width: 75%; float: left">
                ...
                <div class="box box50 no-margim">
                    ...
                    <input name="senha" type="password" required placeholder="Senha" style=" width: 100%;" />
                </div>
                <div class="limpar"></div>
                <div class="box box33">
               ...
               if (dashboard == 'ON'):
                  ?>
                    <div class="mylabel">
                        ...
                        <label class="mylabel" for="coding" name="1">
               ...
               if (depoimentos == 'ON'):
                  ?>
                    <div class="mylabel">
                        ...
                        <div class="slidinggroove"></div>
                        <label class="mylabel" for="coding2" name="2">
               ...
               if (arquivos == 'ON'):
                  ?>
                    <div class="mylabel">
                        ...
                        <div class="slidinggroove"></div>
                        <label class="mylabel" for="coding3" name="3">
               ...
               if (newsletter == 'ON'):
                  ?>
                    <div class="mylabel">
                        ...
                        <div class="slidinggroove"></div>
                        <label class="mylabel" for="coding4" name="4">
               ...
               if (sac == 'ON'):
                  ?>
                    <div class="mylabel">
                        ...
                        <div class="slidinggroove"></div>
                        <label class="mylabel" for="coding5" name="5">
               ...
               if (cadastrar_usuario == 'ON'):
                  ?>
                    <div class="mylabel">
                        ...
                        <div class="slidinggroove"></div>
                        <label class="mylabel" for="coding6" name="6">
               ...
               if (cliente == 'ON'):
                  ?>
                    <div class="mylabel">
                        ...
                        <div class="slidinggroove"></div>
                        <label class="mylabel" for="coding7" name="7">
               ...
               if (cliente_usuario == 'ON'):
                  ?>
                    <div class="mylabel">
                        ...
                        <div class="slidinggroove"></div>
                        <label class="mylabel" for="coding8" name="8">
               ...
               if (blog == 'ON'):
                  ?>
                    <div class="mylabel">
                        ...
                        <div class="slidinggroove"></div>
                        <label class="mylabel" for="coding9" name="9">
               ...
               if (crm == 'ON'):
                  ?>
                    <div class="mylabel">
                        ...
                        <div class="slidinggroove"></div>
                        <label class="mylabel" for="coding10" name="10">
               ...
               if (agenda == 'ON'):
                  ?>
                    <div class="mylabel">
                        ...
                        <div class="slidinggroove"></div>
                        <label class="mylabel" for="coding11" name="11">
              ...
              if (orientador == 'ON'):
                  ?>
                    <div class="mylabel">
                        ...
                        <div class="slidinggroove"></div>
                        <label class="mylabel" for="coding12" name="12">
