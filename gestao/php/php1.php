    ...
    <div class="box box100">
        <div class="box box100">
            ...
            <div class="box box50">
                ...
                <div class="box box100">
                    <p class="texto_form">Comprovante de patrimônio Gen. e de conhecimento tradicional(SIGEN) (obrigatório)</p>
                    <!-- <label class="label_file" for='selecao-arquivo2'>Selecionar um arquivo</label> -->
                ...
                <div class="box box100">
                    <p class="texto_form">Curriculos na plataforma Lattes do CNPq (obrigatório)</p>
                    <!-- <label class="label_file" for='selecao-arquivo2'>Selecionar um arquivo</label> -->
