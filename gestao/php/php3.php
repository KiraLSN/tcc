        ...
        <div class="box box100">
            ...
            <div class="box box33 no-margim">
                ...
                <select class="" name="tipo" style=" width: 100%;">
                    <option <?= ($resultado['tipo'] == "1" ? "selected" : ""); ?> value="1">Projeto</option>
                    <option <?= ($resultado['tipo'] == "2" ? "selected" : ""); ?> value="2">Melhoria</option>
                </select>
            </div>
            <div class="limpar"></div>
            <?php
            ...
            <div class="forms_exta" style=" width: 100%; padding: 2%; background: #f1f1f1; border: 0.9% solid #333; margin-bottom: 3%">
                ...
                <div class="box box100">
                    ...
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_ori4"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
            ...
            <div class="box box50">
                ...
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_ori5"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
                ...
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_ori6"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
                ...
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_ori7"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
                ...
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_ori8"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
                ...
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_ori9"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
                ...
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_ori10"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
                ...
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_ori11"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
                ...
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_ori12"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
                <div class="limpar"></div>
            </div>
            ...
            <div class="box box50 no-margim">
                ...
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_co3"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_2"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
                ...
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_co4"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_3"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
                ...
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_5"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
                ...
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_6"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
                ...
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_8"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_9"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
            </div>
            <div class="limpar"></div>
            ...
            <div class="box box50">
              ...
              ?>
                ...
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_co"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
                ...
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_co2"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                    <?php endif; ?>
                </div>
                <?php
              }
    ...
    <div class="box box100">
        <div class="box box100">
            ...
            <div class="box box50">
                ...
                <p class="texto_form" style=" color: red">Arquivo não enviado</p>
                <?php else : ?>
                <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_1"]; ?>" style=" color: black" target="_blank">Verificar arquivo</a>
                <?php endif; ?>
            </div>
            <div class="box box50 no-margim">
                <p class="texto_form">Currículo lattes do co-autor (obrigatório)</p>
