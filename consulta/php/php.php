    ...
    <div class="box box100">
        <div class="box box100">
            <div class="box box33">
                ...
                <input name="nome" type="text" placeholder="Nome do Projeto" readonly value="<?= $resultado['nome']; ?>" style=" width: 100%;" />
            </div>
            <div class="box box33">
            ...
            <div class="box box33">
                ...
                <input name="cr" type="text" placeholder="Andamento" readonly value="<?= $resultado['cr']; ?>" id="" style=" width: 100%;" />
            </div>
            <div class="box box33 no-margim">
                <p class="texto_form">Tipo</p>
                <select class="" disabled readonly name="tipo" style=" width: 100%;">
            ...
            <div class="box box33 ">
                <p class="texto_form">Status</p>
                <select class="" disabled readonly name="status" style=" width: 100%;">
            ...
            <div class="box box33">
                ...
                <input type="date" readonly disabled value="<?= $resultado['entrega']; ?>" name="entrega" style="width: 100%;">
            </div>

            <div class="box box33">
                <p class=" texto_form">Avaliação</p>
                <input type="text" readonly disabled value="<?= $resultado['nota']; ?>" name="nota" style="width: 100%;" min="0" max="10">
            </div>
            ...
            <div class="box box50">
                ...
                <div class="box box100">
                    ...
                    <p class="texto_form" style=" color: red">Arquivo não enviado!</p>
                    <?php else : ?>
                    <a href="<?= CORDENADOR; ?>imagens_site/<?= $resultado["arq_ori5"]; ?>"kly style=" color: red" target="_blank">Verificar arquivo!</a>
                    <?php endif; ?>
                </div>
