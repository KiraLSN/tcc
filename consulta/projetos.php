...
$titulo_botao_de_acesso = 'Cadastrar novo Projeto';
...
<section class="box conteudo conteudo-completo">
    ...
    <article class="listagem" style="float: left; width: 100%; background: #fff;">
        ...
        <div class="box_conteudo_ lista_atual">
            ...
            //echo $usuario_['nome'];
            $listagem2 = new Read;
            $listagem2->ExeRead('orientador', "where id > 0 ");
         ...
         $listagem = new Read;
            try{
                ...
                echo "Supervisor/Orientador sem projetos cadastrados";
            }    
            
         $listagem->ExeRead('aluno', "where status != 3 AND status != 0 order by status asc");
